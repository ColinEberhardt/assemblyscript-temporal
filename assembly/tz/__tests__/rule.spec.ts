...
import { DayOfMonth, DayOfMonthCalculator, LastDay, NextDayAfter, Rule } from "../rule";
...
describe("matches on date", () => {
  it("matches if year within range", () => {
    rule = new Rule("EU", 1979, 1995, 2, new LastDay(0), 60);
  ...
  it("matches when toYear is undefined", () => {
    rule = new Rule("EU", 1979, -1, 2, new LastDay(0), 60);
  ...
  it("matches DayOfMonthCalculator rule", () => {
    rule = new Rule("EU", 1979, -1, 2, new DayOfMonth(10), 0);
  ...
  it("matches time rule", () => {
    rule = new Rule("EU", 1979, -1, 2, new DayOfMonth(10), 120);
