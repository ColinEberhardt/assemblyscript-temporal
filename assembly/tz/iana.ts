...
const rules = [
  ...
  new Rule("Cuba", 1997, 1997, 10, new DayOfMonth(12), 0, AtTimeZone.Local, 0),
  // Rule    Cuba	1998	1999	-	Mar	lastSun	0:00s	1:00	D
  new Rule("Cuba", 1998, 1999, 3, new LastDay(7), 0, AtTimeZone.Local, 3600000),
  ...
  new Rule("Cuba", 2004, 2004, 3, new LastDay(7), 0, AtTimeZone.Local, 3600000),
  ...
  new Rule("Cuba", 2011, 2011, 11, new DayOfMonth(13), 0, AtTimeZone.Local, 0),
  ...
  new Rule("Eire", 1996, -1, 10, new LastDay(7), 60, AtTimeZone.UTC, -3600000),
  ...
  new Rule("W-Eur", 1978, 1978, 10, new DayOfMonth(1), 60, AtTimeZone.Local, 0),
  // Rule    W-Eur	1979	1995	-	Sep	lastSun	 1:00s	0	-
  new Rule("W-Eur", 1979, 1995, 9, new LastDay(7), 60, AtTimeZone.Local, 0),
  // Rule    W-Eur	1981	max	-	Mar	lastSun	 1:00s	1:00	S
  new Rule("W-Eur", 1981, -1, 3, new LastDay(7), 60, AtTimeZone.Local, 3600000),
  ...
  new Rule("Russia", 1996, 2010, 10, new LastDay(7), 120, AtTimeZone.Local, 0),
  ...
  new Rule("Italy", 1947, 1947, 10, new DayOfMonth(5), 0, AtTimeZone.Local, 0),
  ...
  new Rule("Italy", 1972, 1972, 10, new DayOfMonth(1), 0, AtTimeZone.Local, 0),
  ...
  new Rule("Italy", 1978, 1978, 10, new DayOfMonth(1), 0, AtTimeZone.Local, 0),
  // Rule    Italy	1979	only	-	Sep	30	 0:00s	0	-
  new Rule("Italy", 1979, 1979, 9, new DayOfMonth(30), 0, AtTimeZone.Local, 0),
  ...
  new Rule("Malta", 1973, 1973, 9, new DayOfMonth(29), 0, AtTimeZone.Local, 0),
  ...
  new Rule("Malta", 1974, 1974, 9, new DayOfMonth(16), 0, AtTimeZone.Local, 0),
  ...
  new Rule("Neth", 1917, 1917, 9, new DayOfMonth(17), 120, AtTimeZone.Local, 0),
  ...
  new Rule("Neth", 1945, 1945, 9, new DayOfMonth(16), 120, AtTimeZone.Local, 0),
  ...
  new Rule("Port", 1980, 1980, 3, new LastDay(7), 0, AtTimeZone.Local, 3600000),
